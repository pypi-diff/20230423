# Comparing `tmp/sitcom-0.3.0.tar.gz` & `tmp/sitcom-1.0.0.tar.gz`
...
## Comparing `sitcom-0.3.0.tar` & `sitcom-1.0.0.tar`
...
### Comparing `sitcom-0.3.0/LICENSE` & `sitcom-1.0.0/LICENSE`

 * *Files identical despite different names*

### Comparing `sitcom-0.3.0/README.md` & `sitcom-1.0.0/README.md`

 * *Files identical despite different names*

### Comparing `sitcom-0.3.0/sitcom/__main__.py` & `sitcom-1.0.0/sitcom/__main__.py`
...
### Comparing `sitcom-0.3.0/sitcom/sfit.py` & `sitcom-1.0.0/sitcom/sfit.py`

 * *Files identical despite different names*

### Comparing `sitcom-0.3.0/sitcom/sirgraf.py` & `sitcom-1.0.0/sitcom/sirgraf.py`

 * *Files identical despite different names*

### Comparing `sitcom-0.3.0/sitcom/st1.py` & `sitcom-1.0.0/sitcom/st1.py`
...
### Comparing `sitcom-0.3.0/sitcom/st2.py` & `sitcom-1.0.0/sitcom/st2.py`
