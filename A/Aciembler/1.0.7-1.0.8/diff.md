# Comparing `tmp/Aciembler-1.0.7-py2.py3-none-any.whl.zip` & `tmp/Aciembler-1.0.8-py2.py3-none-any.whl.zip`
...
@@ -13,15 +13,15 @@
 ...
 def new_file():
     ...
     while ((path := filedialog.asksaveasfilename(defaultextension='.xlsx')) == ''):
         pass
     try:
-        shutil.copy(base + '/System file/Template.xlsx', path)
...
## Comparing `Aciembler-1.0.7.data/data/Aciembler/System file/Template.xlsx` & `data/Template.xlsx`

 * *Files identical despite different names*

## Comparing `Aciembler-1.0.7.dist-info/LICENSE.txt` & `Aciembler-1.0.8.dist-info/LICENSE.txt`

 * *Files identical despite different names*

## Comparing `Aciembler-1.0.7.dist-info/METADATA` & `Aciembler-1.0.8.dist-info/METADATA`
...
## Comparing `Aciembler-1.0.7.dist-info/RECORD` & `Aciembler-1.0.8.dist-info/RECORD`

 * *Files 22% similar despite different names*

```diff
@@ -1,12 +1,13 @@
-Aciembler/Aciembler.py,sha256=wWwPfaGOpyuFPfAicQ6q4ztwb6hJumoMf-_aQBd3vnk,3190
...
-Aciembler-1.0.7.data/data/Aciembler/System file/Template.xlsx,sha256=USSyDCqjP_lrb5zUIibSM-KZX5ToAg-qLG1iuuL-lnE,10686
-Aciembler-1.0.7.dist-info/LICENSE.txt,sha256=38hGaAYWJOuEjGRNUyJtwqSjp0GODZZ9UWoMtBbhaG8,1091
-Aciembler-1.0.7.dist-info/METADATA,sha256=tN2oklNESz3gmAptdpENwvchPWV5vK0HY75_zZJZBNw,685
-Aciembler-1.0.7.dist-info/WHEEL,sha256=z9j0xAa_JmUKMpmz72K0ZGALSM_n-wQVmGbleXx2VHg,110
-Aciembler-1.0.7.dist-info/top_level.txt,sha256=pxsIJ5iLkKlA9kUzML4tWwn-4XzsD0alCIx1d2IgBRk,10
-Aciembler-1.0.7.dist-info/RECORD,,
