# Comparing `tmp/gpt_gateway-0.0.7.tar.gz` & `tmp/gpt_gateway-0.0.8.tar.gz`
...
### Comparing `gpt_gateway-0.0.7/gpt_gateway/client.py` & `gpt_gateway-0.0.8/gpt_gateway/client.py`
