# Comparing `tmp/xztrainer-0.9.3.tar.gz` & `tmp/xztrainer-0.9.4.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "xztrainer-0.9.3.tar", max compression
+gzip compressed data, was "xztrainer-0.9.4.tar", max compression
```

## Comparing `xztrainer-0.9.3.tar` & `xztrainer-0.9.4.tar`

### file list

```diff
@@ -1,15 +1,15 @@
--rw-r--r--   0        0        0      894 2023-03-15 12:12:39.576018 xztrainer-0.9.3/pyproject.toml
--rw-r--r--   0        0        0       46 1970-01-01 00:00:00.000000 xztrainer-0.9.3/src/xztrainer/__init__.py
--rw-r--r--   0        0        0      256 2023-03-14 15:54:26.631822 xztrainer-0.9.3/src/xztrainer/functional.py
--rw-r--r--   0        0        0     1414 1970-01-01 00:00:00.000000 xztrainer-0.9.3/src/xztrainer/logger/__init__.py
--rw-r--r--   0        0        0     1590 1970-01-01 00:00:00.000000 xztrainer-0.9.3/src/xztrainer/logger/compose.py
--rw-r--r--   0        0        0      384 1970-01-01 00:00:00.000000 xztrainer-0.9.3/src/xztrainer/logger/null.py
--rw-r--r--   0        0        0     1094 1970-01-01 00:00:00.000000 xztrainer-0.9.3/src/xztrainer/logger/stream.py
--rw-r--r--   0        0        0     1259 1970-01-01 00:00:00.000000 xztrainer-0.9.3/src/xztrainer/logger/tensorboard.py
--rw-r--r--   0        0        0     1614 2023-03-07 16:50:41.028747 xztrainer-0.9.3/src/xztrainer/model.py
--rw-r--r--   0        0        0      743 2023-03-10 15:49:26.715934 xztrainer-0.9.3/src/xztrainer/rng.py
--rw-r--r--   0        0        0     1060 1970-01-01 00:00:00.000000 xztrainer-0.9.3/src/xztrainer/sampler.py
--rw-r--r--   0        0        0      409 2023-03-10 15:49:26.707934 xztrainer-0.9.3/src/xztrainer/setup_helper.py
--rw-r--r--   0        0        0    23984 2023-03-15 12:12:24.384173 xztrainer-0.9.3/src/xztrainer/xztrainer.py
--rw-r--r--   0        0        0      908 1970-01-01 00:00:00.000000 xztrainer-0.9.3/setup.py
--rw-r--r--   0        0        0      830 1970-01-01 00:00:00.000000 xztrainer-0.9.3/PKG-INFO
...
### Comparing `xztrainer-0.9.3/pyproject.toml` & `xztrainer-0.9.4/pyproject.toml`
...
### Comparing `xztrainer-0.9.3/src/xztrainer/logger/__init__.py` & `xztrainer-0.9.4/src/xztrainer/logger/__init__.py`

 * *Files identical despite different names*

### Comparing `xztrainer-0.9.3/src/xztrainer/logger/compose.py` & `xztrainer-0.9.4/src/xztrainer/logger/compose.py`

 * *Files identical despite different names*

### Comparing `xztrainer-0.9.3/src/xztrainer/logger/stream.py` & `xztrainer-0.9.4/src/xztrainer/logger/stream.py`

 * *Files identical despite different names*

### Comparing `xztrainer-0.9.3/src/xztrainer/logger/tensorboard.py` & `xztrainer-0.9.4/src/xztrainer/logger/tensorboard.py`

 * *Files identical despite different names*

### Comparing `xztrainer-0.9.3/src/xztrainer/model.py` & `xztrainer-0.9.4/src/xztrainer/model.py`

 * *Files identical despite different names*

### Comparing `xztrainer-0.9.3/src/xztrainer/rng.py` & `xztrainer-0.9.4/src/xztrainer/rng.py`

 * *Files identical despite different names*

### Comparing `xztrainer-0.9.3/src/xztrainer/sampler.py` & `xztrainer-0.9.4/src/xztrainer/sampler.py`

 * *Files identical despite different names*

### Comparing `xztrainer-0.9.3/src/xztrainer/xztrainer.py` & `xztrainer-0.9.4/src/xztrainer/xztrainer.py`
...
### Comparing `xztrainer-0.9.3/setup.py` & `xztrainer-0.9.4/setup.py`
...
### Comparing `xztrainer-0.9.3/PKG-INFO` & `xztrainer-0.9.4/PKG-INFO`
