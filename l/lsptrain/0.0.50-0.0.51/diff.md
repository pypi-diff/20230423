# Comparing `tmp/lsptrain-0.0.50.tar.gz` & `tmp/lsptrain-0.0.51.tar.gz`
...
## Comparing `lsptrain-0.0.50.tar` & `lsptrain-0.0.51.tar`
...
### Comparing `lsptrain-0.0.50/lsptrain/nlp_classification/model.py` & `lsptrain-0.0.51/lsptrain/nlp_classification/model.py`

 * *Files identical despite different names*

### Comparing `lsptrain-0.0.50/lsptrain/nlp_classification/train_scripts.py` & `lsptrain-0.0.51/lsptrain/nlp_classification/train_scripts.py`

 * *Files identical despite different names*

### Comparing `lsptrain-0.0.50/lsptrain/nlp_classification_server/fastapi_server.py` & `lsptrain-0.0.51/lsptrain/nlp_classification_server/fastapi_server.py`

 * *Files identical despite different names*

### Comparing `lsptrain-0.0.50/lsptrain/nlp_classification_server/predictor.py` & `lsptrain-0.0.51/lsptrain/nlp_classification_server/predictor.py`
...
@@ -55,15 +55,15 @@
         ...
         with open(file=os.path.join(save_dir, label_file_name), mode="r", encoding="utf-8") as f:
             lines = f.readline()
-        self.info_labels = [x.strip() for x in lines]
...
### Comparing `lsptrain-0.0.50/lsptrain.egg-info/SOURCES.txt` & `lsptrain-0.0.51/lsptrain.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `lsptrain-0.0.50/setup.py` & `lsptrain-0.0.51/setup.py`
