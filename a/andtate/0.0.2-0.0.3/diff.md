# Comparing `tmp/andtate-0.0.2.tar.gz` & `tmp/andtate-0.0.3.tar.gz`
...
## Comparing `andtate-0.0.2.tar` & `andtate-0.0.3.tar`
...
### Comparing `andtate-0.0.2/LICENSE` & `andtate-0.0.3/LICENSE`

 * *Files identical despite different names*

### Comparing `andtate-0.0.2/PKG-INFO` & `andtate-0.0.3/PKG-INFO`
...
### Comparing `andtate-0.0.2/andtate/AMDL.py` & `andtate-0.0.3/andtate/AMDL.py`

 * *Files identical despite different names*

### Comparing `andtate-0.0.2/andtate/NLP.py` & `andtate-0.0.3/andtate/NLP.py`

 * *Files identical despite different names*

### Comparing `andtate-0.0.2/andtate.egg-info/PKG-INFO` & `andtate-0.0.3/andtate.egg-info/PKG-INFO`
...
### Comparing `andtate-0.0.2/setup.py` & `andtate-0.0.3/setup.py`
