# Comparing `tmp/onvif_gui-1.0.1.tar.gz` & `tmp/onvif_gui-1.0.2.tar.gz`
...
### Comparing `onvif_gui-1.0.1/LICENSE` & `onvif_gui-1.0.2/LICENSE`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/PKG-INFO` & `onvif_gui-1.0.2/PKG-INFO`
...
### Comparing `onvif_gui-1.0.1/README.md` & `onvif_gui-1.0.2/README.md`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/components/comboselector.py` & `onvif_gui-1.0.2/onvif_gui/components/comboselector.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/components/fileselector.py` & `onvif_gui-1.0.2/onvif_gui/components/fileselector.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/components/labelselector.py` & `onvif_gui-1.0.2/onvif_gui/components/labelselector.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/components/progress.py` & `onvif_gui-1.0.2/onvif_gui/components/progress.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/components/thresholdslider.py` & `onvif_gui-1.0.2/onvif_gui/components/thresholdslider.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/checkpoint/c2_model_loading.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/checkpoint/c2_model_loading.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/checkpoint/catalog.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/checkpoint/catalog.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/checkpoint/detection_checkpoint.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/checkpoint/detection_checkpoint.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/config/__init__.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/config/__init__.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/config/compat.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/config/compat.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/config/config.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/config/config.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/config/defaults.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/config/defaults.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/config/instantiate.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/config/instantiate.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/config/lazy.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/config/lazy.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/__init__.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/__init__.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/benchmark.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/benchmark.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/build.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/build.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/catalog.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/catalog.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/common.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/common.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/dataset_mapper.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/dataset_mapper.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/datasets/__init__.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/datasets/__init__.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/datasets/builtin.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/datasets/builtin.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/datasets/builtin_meta.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/datasets/builtin_meta.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/datasets/cityscapes.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/datasets/cityscapes.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/datasets/cityscapes_panoptic.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/datasets/cityscapes_panoptic.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/datasets/coco.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/datasets/coco.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/datasets/coco_panoptic.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/datasets/coco_panoptic.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/datasets/lvis.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/datasets/lvis.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/datasets/lvis_v0_5_categories.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/datasets/lvis_v0_5_categories.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/datasets/lvis_v1_categories.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/datasets/lvis_v1_categories.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/datasets/lvis_v1_category_image_count.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/datasets/lvis_v1_category_image_count.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/datasets/pascal_voc.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/datasets/pascal_voc.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/detection_utils.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/detection_utils.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/samplers/distributed_sampler.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/samplers/distributed_sampler.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/samplers/grouped_batch_sampler.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/samplers/grouped_batch_sampler.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/transforms/augmentation.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/transforms/augmentation.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/transforms/augmentation_impl.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/transforms/augmentation_impl.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/data/transforms/transform.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/data/transforms/transform.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/layers/__init__.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/layers/__init__.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/layers/aspp.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/layers/aspp.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/layers/batch_norm.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/layers/batch_norm.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/layers/blocks.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/layers/blocks.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/layers/deform_conv.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/layers/deform_conv.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/layers/losses.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/layers/losses.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/layers/mask_ops.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/layers/mask_ops.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/layers/nms.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/layers/nms.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/layers/roi_align.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/layers/roi_align.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/layers/roi_align_rotated.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/layers/roi_align_rotated.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/layers/rotated_boxes.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/layers/rotated_boxes.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/layers/shape_spec.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/layers/shape_spec.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/layers/wrappers.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/layers/wrappers.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/__init__.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/__init__.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/anchor_generator.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/anchor_generator.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/backbone/__init__.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/backbone/__init__.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/backbone/backbone.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/backbone/backbone.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/backbone/build.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/backbone/build.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/backbone/fpn.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/backbone/fpn.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/backbone/mvit.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/backbone/mvit.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/backbone/regnet.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/backbone/regnet.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/backbone/resnet.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/backbone/resnet.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/backbone/swin.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/backbone/swin.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/backbone/utils.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/backbone/utils.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/backbone/vit.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/backbone/vit.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/box_regression.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/box_regression.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/matcher.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/matcher.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/meta_arch/build.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/meta_arch/build.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/meta_arch/dense_detector.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/meta_arch/dense_detector.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/meta_arch/fcos.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/meta_arch/fcos.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/meta_arch/panoptic_fpn.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/meta_arch/panoptic_fpn.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/meta_arch/rcnn.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/meta_arch/rcnn.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/meta_arch/retinanet.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/meta_arch/retinanet.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/meta_arch/semantic_seg.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/meta_arch/semantic_seg.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/mmdet_wrapper.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/mmdet_wrapper.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/poolers.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/poolers.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/postprocessing.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/postprocessing.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/proposal_generator/build.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/proposal_generator/build.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/proposal_generator/proposal_utils.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/proposal_generator/proposal_utils.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/proposal_generator/rpn.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/proposal_generator/rpn.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/proposal_generator/rrpn.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/proposal_generator/rrpn.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/roi_heads/__init__.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/roi_heads/__init__.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/roi_heads/box_head.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/roi_heads/box_head.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/roi_heads/cascade_rcnn.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/roi_heads/cascade_rcnn.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/roi_heads/fast_rcnn.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/roi_heads/fast_rcnn.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/roi_heads/keypoint_head.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/roi_heads/keypoint_head.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/roi_heads/mask_head.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/roi_heads/mask_head.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/roi_heads/roi_heads.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/roi_heads/roi_heads.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/roi_heads/rotated_fast_rcnn.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/roi_heads/rotated_fast_rcnn.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/sampling.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/sampling.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/modeling/test_time_augmentation.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/modeling/test_time_augmentation.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/predictor.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/predictor.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/structures/__init__.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/structures/__init__.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/structures/boxes.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/structures/boxes.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/structures/image_list.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/structures/image_list.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/structures/instances.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/structures/instances.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/structures/keypoints.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/structures/keypoints.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/structures/masks.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/structures/masks.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/structures/rotated_boxes.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/structures/rotated_boxes.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/tracker.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/tracker.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/utils/analysis.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/utils/analysis.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/utils/collect_env.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/utils/collect_env.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/utils/colormap.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/utils/colormap.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/utils/comm.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/utils/comm.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/utils/develop.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/utils/develop.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/utils/env.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/utils/env.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/utils/events.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/utils/events.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/utils/file_io.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/utils/file_io.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/utils/logger.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/utils/logger.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/utils/memory.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/utils/memory.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/utils/registry.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/utils/registry.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/utils/serialize.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/utils/serialize.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/utils/testing.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/utils/testing.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/utils/video_visualizer.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/utils/video_visualizer.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/detectron2/utils/visualizer.py` & `onvif_gui-1.0.2/onvif_gui/detectron2/utils/visualizer.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/glwidget.py` & `onvif_gui-1.0.2/onvif_gui/glwidget.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/main.py` & `onvif_gui-1.0.2/onvif_gui/main.py`
...
### Comparing `onvif_gui-1.0.1/onvif_gui/modules/keypoint.py` & `onvif_gui-1.0.2/onvif_gui/modules/keypoint.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/modules/retinanet.py` & `onvif_gui-1.0.2/onvif_gui/modules/retinanet.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/modules/sample.py` & `onvif_gui-1.0.2/onvif_gui/modules/sample.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/modules/segment.py` & `onvif_gui-1.0.2/onvif_gui/modules/segment.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/modules/yolox.py` & `onvif_gui-1.0.2/onvif_gui/modules/yolox.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/onvif/admintab.py` & `onvif_gui-1.0.2/onvif_gui/onvif/admintab.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/onvif/imagetab.py` & `onvif_gui-1.0.2/onvif_gui/onvif/imagetab.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/onvif/logindialog.py` & `onvif_gui-1.0.2/onvif_gui/onvif/logindialog.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/onvif/networktab.py` & `onvif_gui-1.0.2/onvif_gui/onvif/networktab.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/onvif/ptztab.py` & `onvif_gui-1.0.2/onvif_gui/onvif/ptztab.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/onvif/videotab.py` & `onvif_gui-1.0.2/onvif_gui/onvif/videotab.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/panels/camerapanel.py` & `onvif_gui-1.0.2/onvif_gui/panels/camerapanel.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/panels/filepanel.py` & `onvif_gui-1.0.2/onvif_gui/panels/filepanel.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/panels/modulepanel.py` & `onvif_gui-1.0.2/onvif_gui/panels/modulepanel.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/panels/settingspanel.py` & `onvif_gui-1.0.2/onvif_gui/panels/settingspanel.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/resources/LICENSE` & `onvif_gui-1.0.2/onvif_gui/resources/LICENSE`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/resources/audio.png` & `onvif_gui-1.0.2/onvif_gui/resources/audio.png`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/resources/audio_hi.png` & `onvif_gui-1.0.2/onvif_gui/resources/audio_hi.png`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/resources/audio_lo.png` & `onvif_gui-1.0.2/onvif_gui/resources/audio_lo.png`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/resources/darkstyle.qss` & `onvif_gui-1.0.2/onvif_gui/resources/darkstyle.qss`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/resources/discover.png` & `onvif_gui-1.0.2/onvif_gui/resources/discover.png`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/resources/discover_hi.png` & `onvif_gui-1.0.2/onvif_gui/resources/discover_hi.png`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/resources/discover_lo.png` & `onvif_gui-1.0.2/onvif_gui/resources/discover_lo.png`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/resources/mute.png` & `onvif_gui-1.0.2/onvif_gui/resources/mute.png`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/resources/mute_lo.png` & `onvif_gui-1.0.2/onvif_gui/resources/mute_lo.png`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/resources/onvif_gui.png` & `onvif_gui-1.0.2/onvif_gui/resources/onvif_gui.png`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/resources/recording_lo.png` & `onvif_gui-1.0.2/onvif_gui/resources/recording_lo.png`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/resources/resources.qrc` & `onvif_gui-1.0.2/onvif_gui/resources/resources.qrc`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/resources/resources.rcc` & `onvif_gui-1.0.2/onvif_gui/resources/resources.rcc`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/yolox/models/__init__.py` & `onvif_gui-1.0.2/onvif_gui/yolox/models/__init__.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/yolox/models/build.py` & `onvif_gui-1.0.2/onvif_gui/yolox/models/build.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/yolox/models/darknet.py` & `onvif_gui-1.0.2/onvif_gui/yolox/models/darknet.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/yolox/models/losses.py` & `onvif_gui-1.0.2/onvif_gui/yolox/models/losses.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/yolox/models/network_blocks.py` & `onvif_gui-1.0.2/onvif_gui/yolox/models/network_blocks.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/yolox/models/yolo_fpn.py` & `onvif_gui-1.0.2/onvif_gui/yolox/models/yolo_fpn.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/yolox/models/yolo_head.py` & `onvif_gui-1.0.2/onvif_gui/yolox/models/yolo_head.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/yolox/models/yolo_pafpn.py` & `onvif_gui-1.0.2/onvif_gui/yolox/models/yolo_pafpn.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/yolox/models/yolox.py` & `onvif_gui-1.0.2/onvif_gui/yolox/models/yolox.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/yolox/tracker/basetrack.py` & `onvif_gui-1.0.2/onvif_gui/yolox/tracker/basetrack.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/yolox/tracker/byte_tracker.py` & `onvif_gui-1.0.2/onvif_gui/yolox/tracker/byte_tracker.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/yolox/tracker/kalman_filter.py` & `onvif_gui-1.0.2/onvif_gui/yolox/tracker/kalman_filter.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/yolox/tracker/matching.py` & `onvif_gui-1.0.2/onvif_gui/yolox/tracker/matching.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui/yolox/utils/utils.py` & `onvif_gui-1.0.2/onvif_gui/yolox/utils/utils.py`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/onvif_gui.egg-info/PKG-INFO` & `onvif_gui-1.0.2/onvif_gui.egg-info/PKG-INFO`
...
### Comparing `onvif_gui-1.0.1/onvif_gui.egg-info/SOURCES.txt` & `onvif_gui-1.0.2/onvif_gui.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `onvif_gui-1.0.1/pyproject.toml` & `onvif_gui-1.0.2/pyproject.toml`
...
### Comparing `onvif_gui-1.0.1/setup.py` & `onvif_gui-1.0.2/setup.py`
