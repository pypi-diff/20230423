# Comparing `tmp/hera_workflows-5.1.4.tar.gz` & `tmp/hera_workflows-5.1.5.tar.gz`
...
### Comparing `hera_workflows-5.1.4/src/hera/workflows/cron_workflow.py` & `hera_workflows-5.1.5/src/hera/workflows/cron_workflow.py`
